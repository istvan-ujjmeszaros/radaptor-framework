...
/*
 * Compatibility backfill for branch-local databases where 125000-127000 were
 * already applied before host-root aliases were normalized to the configured
 * site key. This is intentionally idempotent and preserves existing migration
 * tracker rows without manual cleanup.
 *
 * The canonical fresh-install repair path is 125000.
 */
class Migration_20260504_128000_repair_configured_site_pages_after_cutover
{
	public function getDescription(): string
	{
		return 'Repair configured-site login and developer pages after site-context cutover.';
	}
